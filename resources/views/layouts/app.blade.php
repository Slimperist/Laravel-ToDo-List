...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('tasks.tag_filter') }}">Фильтр по тэгам для задач</a>
            </li>


            <form class="form-inline my-2 my-lg-0" action="{{ route('tasks.search') }}" method="GET">
        ...
        @else
            <form class="form-inline my-2 my-lg-0" method="POST" action="{{ route('login') }}">
                @csrf
                <input class="form-control mr-sm-2" type="email" id="email" name="email" value="{{ old('email') }}" required autofocus>
