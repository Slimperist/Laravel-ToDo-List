<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-sm-4 col-12">
            <div class="card">
                <?php if($task->image): ?>
                    <a target="_blank" href="<?php echo e(asset('images/' . $task->image)); ?>"><img class="" src="<?php echo e(asset('images/thumbnails/' . $task->image)); ?>" alt="Card image cap" style="max-width:150px; max-height:150px"></a>
                <?php endif; ?>
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\to-do\to-do\to-do\resources\views/tasks/index.blade.php ENDPATH**/ ?>